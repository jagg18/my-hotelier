...
<div id="page">
	...
	<div id="sidebar">
		<table BORDER=1 RULES=ROWS FRAME=BOX>
			<?php
				//pagination
				$result=mysql_query("SELECT * from ROOM_TYPE");
				...
				if((!$page) || (is_numeric($page) == false) || ($page < 0) || ($page > $totalitems)) {
				 ...
				 $result=mysql_query("SELECT * from ROOM_TYPE LIMIT $set_limit, $limit");
				 
				 
				
				echo "<tr align='center'><td width='150'>Room Type Name</td><td width='100'>Room Rate</td><td width='50'>Capacity</td><td width='150'>Extra Person Rate</td>";
				while($row = mysql_fetch_array($result)) {
						echo "<tr align='center'><td>".$row['TYPE_NAME']."</td><td>".$row['TYPE_RATE']."</td><td>".$row['TYPE_CAPACITY']."</td><td>".$row['TYPE_EXTRA']."</td>";
						echo "<td><a href='editTypes.php?id=".$row['TYPE_ID']."'><img src='../images/edit.png'></img></a></td>";
						echo "<td><a href='deleteTypes.php?id=".$row['TYPE_ID']."'><img src='../images/delete.png'></img></a></td>";
						echo "</tr>";
				}
				echo "</tr>";
