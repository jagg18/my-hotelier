...
<div id="page">
	...
	<div id="sidebar">
		...
		<?php
			...
			$addType=$_GET['type'];
			if(isset($addType)) {
				printadduserform($addType);
			}
			else {
				echo "<table width='650' height='142' border='0'>
				<tr>
				<td><a href='addUsers.php?type=2'><img src='../images/admin.gif'></img></a></td>
				<td><a href='addUsers.php?type=3'><img src='../images/clerk.gif'></img></a></td>
				<td><a href='addUsers.php?type=4'><img src='../images/staff.gif'></img></a></td>
				</tr>
				</table>";
			}
