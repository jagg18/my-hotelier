...
$result=mysql_query("SELECT * FROM ROOM_ASSIGNMENT,RESERVATION,USER,ROOM WHERE ROOM_ASSIGNMENT.ROOM_ID=ROOM.ROOM_ID AND RESERVATION.ROOM_ASSIGNMENT_ID=ROOM_ASSIGNMENT.ROOM_ASSIGNMENT_ID AND USER.USER_ID=RESERVATION.GUEST_ID AND ROOM.ROOM_ID='13'");
...
$result=mysql_query("SELECT SUM(QTY) AS QTY, ITEM_NAME, ITEM_PRICE FROM ROOM,ROOM_SERVICE,SERVICE_ITEM WHERE ROOM.ROOM_ID='13' AND ROOM_SERVICE.ROOM_ID=ROOM.ROOM_ID AND ROOM_SERVICE.ITEM_ID=SERVICE_ITEM.ITEM_ID GROUP BY SERVICE_ITEM.ITEM_ID");
//Column widths
