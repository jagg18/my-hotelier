	...
	<div id="nav">
		...
		<div id="page">
			...
			<div id="sidebar">
				<?php
				//pagination
				$result3 = mysql_query("SELECT * from RESERVATION WHERE RESERVATION_ID NOT IN (SELECT RESERVATION_ID FROM ROOM_ASSIGNMENT)");
				...
				$result3 = mysql_query("SELECT * from RESERVATION WHERE RESERVATION_ID NOT IN (SELECT RESERVATION_ID FROM ROOM_ASSIGNMENT) LIMIT $set_limit, $limit");


				echo "<h3>Pending Reservation Requests</h3><br>";
				echo "<table width= '650' height='100' BORDER=1 RULES=ROWS FRAME=BOX align='left'>";
				...
				while ($row2 = mysql_fetch_array($result3)) {
					...
					echo "<td><a href='assignRoom.php?id=" . $row2['RESERVATION_ID'] . "'><img src='../images/door.jpg'></img></a></td>";
